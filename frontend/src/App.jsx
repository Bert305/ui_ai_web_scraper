  ...
  return (
    <main className="page">
      <section className="hero">
        <div>
          <p className="eyebrow">AI Scraping Tool</p>
          <h1>Prompt-based Web Scraper</h1>
          <p className="subtitle">
            Enter a URL, describe the data you want, preview the extracted data,
            then export it as CSV or JSON.
          </p>
        </div>
      </section>
